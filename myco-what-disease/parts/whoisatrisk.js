export function getWhoIsAtRiskTemplate(data, type){ return `
    ...
    <div class="detail-modal-body d-slb2">
      ...
      <div class="d-modal-contents">
        ...
        ${getCollectionTemplateFirstLevel(data, type)}
        ${getText(data)}
...
function getCollectionTemplateFirstLevel(data, type){
  if(type.toLowerCase() != 'humans') return ''
  let t = '';
  if (data.collection.length>0) {
      t += `<div class="${type} risk list-container">`;
      data.collectionFirstLevel.forEach((elem) => {
      t += `<div class="w-elem">
              <img src="${elem.img}">
